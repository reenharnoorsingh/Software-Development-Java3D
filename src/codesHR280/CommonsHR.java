...
public class CommonsHR extends JPanel {
    ...
    public CommonsHR(BranchGroup sceneBG) {
    ...
    public static void main(String[] args) {
        ...
        frame.getContentPane().add(new CommonsHR(createScene()));
    }
    ...
    public static class MyGUI extends JFrame {
        ...
        public MyGUI(BranchGroup branchGroup, String title) {
            ...
            frame.getContentPane().add(new CommonsHR(branchGroup));
            pack();
        }
    }
}